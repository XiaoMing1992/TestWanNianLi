...
public class DataBaseUtil {
    ...
    public static String dbName = "Huangli.db";// 数据库的名字
    ...
    public boolean checkDataBase() {
        ...
        try {
            String myPath = context.getFilesDir().getAbsolutePath().replace("files", "databases")+File.separator + dbName;
    ...
    public void copyDataBase() throws IOException {
        ...
        InputStream is = context.getResources().openRawResource(R.raw.huangli);// 得到数据库文件的数据流
